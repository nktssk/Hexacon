...
SWIFT_CLASS("_TtC7Hexacon17HexagonalItemView")
@interface HexagonalItemView : UIImageView
- (void)addImage:(UIImage * __nonnull)image configure:(BOOL)configure borderColor:(UIColor * __nonnull)borderColor borderWidth:(CGFloat)borderWidth;
...
SWIFT_CLASS("_TtC7Hexacon13HexagonalView")
@interface HexagonalView : UIScrollView
...
@interface HexagonalView (SWIFT_EXTENSION(Hexacon))
@end
...
@interface HexagonalView (SWIFT_EXTENSION(Hexacon)) <UIScrollViewDelegate>
